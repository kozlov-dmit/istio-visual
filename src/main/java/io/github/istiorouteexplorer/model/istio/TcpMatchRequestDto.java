...
public class TcpMatchRequestDto {

    private List<String> destinationSubnets;
    private List<String> gateways;
    private Long port;

    public TcpMatchRequestDto(List<String> destinationSubnets, List<String> gateways, Long port) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TcpMatchRequestDto that)) {
            return false;
        }
