...
public class TlsMatchRequestDto {
    ...
    public TlsMatchRequestDto(List<String> destinationSubnets, List<String> gateways, Long port, List<String> sniHosts) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TlsMatchRequestDto that)) {
            return false;
        }
